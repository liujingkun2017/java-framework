...
public class PrimitiveUtils {
    ...
    public static Class<?> getWrapperClass (Class<?> primitiveClass) {
        return getWrapperClass (primitiveClass.getName ());
    }
    ...
    public static boolean isWrapperClass (Class<?> clazz) {
        for (Class<?> c : getAllWrapperClasses ()) {
            if (c.equals (clazz)) {
                return true;
            }
        }
    ...
    public static Class<?> getPrimitiveClass (Class<?> wrapperClass) {
        for (Map.Entry<String, TypeHolder> entry : PRIMITIVES.entrySet ()) {
            TypeHolder typeHolder = entry.getValue ();
            if (typeHolder.getWrapper ().equals (wrapperClass)) {
                return typeHolder.getType ();
            }
        }
        throw new AppException(
                "class : " + wrapperClass.getName () + " is not a primitive wrapper class !");
    }
    ...
    public static Class<?>[] getAllPrimitiveClasses () {
        return new Class<?>[]{Byte.TYPE, Character.TYPE, Short.TYPE, Integer.TYPE, Long.TYPE,
                Float.TYPE, Double.TYPE, Boolean.TYPE};
    }
    ...
    public static Class<?>[] getAllPrimitiveArrayClasses () {
        return new Class<?>[]{byte[].class, char[].class, short[].class, int[].class,
    ...
    public static Class<?>[] getAllWrapperArrayClasses () {
        return new Class<?>[]{Byte[].class, Character[].class, Short[].class, Integer[].class,
                Long[].class, Float[].class, Double[].class, Boolean[].class};
    }
