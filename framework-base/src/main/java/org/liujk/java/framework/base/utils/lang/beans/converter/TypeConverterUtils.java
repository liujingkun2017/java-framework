...
public abstract class TypeConverterUtils {
    ...
    public static Object convertValue (Object value, Class<?> toType) {
        ...
        if (value != null) {
            if (toType.isArray ()) {
                ...
                TypeConverter<Object> typeConverter = (TypeConverter<Object>) TYPE_CONVERTER_MANAGER
                        .getTypeConverter (value.getClass (), toType);
                try {
    ...
    private static TypeConverter<Object> getArrayTypeConvert (Object value, Class<?> toType) {
        ...
        if (typeConverter == null && !toType.getComponentType ().isPrimitive ()) {
            ...
            typeConverter = (TypeConverter<Object>) TYPE_CONVERTER_MANAGER
                    .getTypeConverter (value.getClass (), clazz);
        }
     ...
     */
    @SuppressWarnings("unchecked")
    public static Object convertValue (Map<? extends Object, ? extends Object> parameterMap,
        ...
        if (value != null) {
            if (toType.isArray ()) {
                ...
                try {
                    return typeConverter == null ? value
                            : typeConverter.convert (parameterMap, value,
                ...
                try {
                    return typeConverter == null ? value
                            : typeConverter.convert (parameterMap, value, toType);
                } catch (Exception e) {
                    return value;
                }
            }
    ...
    public static <M extends AccessibleObject & Member> Object convertValue (
            Map<? extends Object, ? extends Object> parameterMap, M m, Object value,
            Class<?> toType) {
        if (toType == null) {
            return value;
        }
        ...
        if (value != null) {
            if (toType.isArray ()) {
                ...
                try {
                    return typeConverter == null ? value
                            : typeConverter.convert (parameterMap, m, value,
                                                     (Class<? extends Object[]>) toType);
                } catch (Exception e) {
                    return value;
                }
    ...
    /**
     * 得到 类型转换器管理器 的一个实例（单例）。该类型转换器管理器为 {@link SimpleTypeConverterManager} 的实例，并且默认注册了
     * {@link com.cqfae.pmo.base.utils.lang.beans.converter} 包下的 TypeConverter 实现类。
     *
     * @return 类型转换管理器 的单例。
     */
