 ...
 * <li>推荐使用Money，不建议直接使用BigDecimal的原因之一在于， 使用BigDecimal，同样金额和币种的货币使用BigDecimal存在多种可能
...
public class Money implements Serializable, Comparable<Object> {
    ...
    public Money (long cent) {
        this (cent, Currency.getByCode (DEFAULT_CURRENCY_CODE));
    }
    ...
    public Money (long yuan, int cent) {
        this (yuan, cent, Currency.getByCode (DEFAULT_CURRENCY_CODE));
    }
    ...
    public Money (String amount) {
        this (amount == null ? "" : amount.replace (",", ""),
              Currency.getByCode (DEFAULT_CURRENCY_CODE));
    }
    ...
    public Money (double amount) {
        this (amount, Currency.getByCode (DEFAULT_CURRENCY_CODE));
    }
    ...
    public Money (BigDecimal amount, int roundingMode) {
        this (amount, Currency.getByCode (DEFAULT_CURRENCY_CODE), roundingMode);
    }
     ...
     * @throws ClassCastException 待比较货币对象不是<code>Money</code>。 IllegalArgumentException 待比较货币对象与本货币对象的币种不同。
