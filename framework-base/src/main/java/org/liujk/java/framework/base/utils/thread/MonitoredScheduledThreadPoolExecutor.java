...
public class MonitoredScheduledThreadPoolExecutor extends ScheduledThreadPoolExecutor {
    ...
    private String metricName = "MonitoredScheduledThreadPoolExecutor";
    ...
    public MonitoredScheduledThreadPoolExecutor (int corePoolSize, ThreadFactory threadFactory) {
        this (corePoolSize, threadFactory, ReporttingRejectedExecutionHandler.DEFAULT);
    }
    ...
    public ScheduledFuture<?> schedule (Runnable command, long delay, TimeUnit unit) {
        ...
        try {
            return super.schedule (wrapAll (command), delay, unit);
    ...
    public <V> ScheduledFuture<V> schedule (Callable<V> callable, long delay, TimeUnit unit) {
        ...
        Preconditions.checkState (initialized);
        try {
            return super.schedule (newTimerCallable (callable), delay, unit);
        } catch (RejectedExecutionException e) {
            submittedCount.decrementAndGet ();
            throw e;
        }
    ...
    public ScheduledFuture<?> scheduleAtFixedRate (Runnable command, long initialDelay, long period, TimeUnit unit) {
        ...
        Preconditions.checkState (initialized);
        try {
            return super.scheduleAtFixedRate (wrapAll (command), initialDelay, period, unit);
        } catch (RejectedExecutionException e) {
            submittedCount.decrementAndGet ();
            throw e;
        }
    ...
    public ScheduledFuture<?> scheduleWithFixedDelay (Runnable command, long initialDelay, long delay, TimeUnit unit) {
        ...
        Preconditions.checkState (initialized);
        try {
            return super.scheduleWithFixedDelay (wrapAll (command), initialDelay, delay, unit);
        } catch (RejectedExecutionException e) {
            submittedCount.decrementAndGet ();
            throw e;
        }
    ...
    private class TimerRunnable implements Runnable {
        ...
        public void run () {
            ...
            Timer.Context taskContext = MonitoredScheduledThreadPoolExecutor.this.taskTimer.time ();
            try {
                task.run ();
            } finally {
                taskContext.stop ();
