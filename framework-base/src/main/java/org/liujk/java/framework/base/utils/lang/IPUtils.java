...
import org.liujk.java.framework.base.utils.security.HexUtils;
...
public class IPUtils {
     ...
     * 获取本地ipv4地址的最后一个字节
     * <p>
     * 例如：61.172.201.235 返回 235
     *
     * @return
     * @see IPUtils#getFirstNoLoopbackIPV4Address()
     */
    public static String getLocalIPV4Suffix () {
        String ip = getFirstNoLoopbackIPV4Address ();
        return getIPV4Suffix (ip);
    }
     ...
     * @return
     */
    public static String getIPV4Suffix (String ip) {
        if (isIP (ip)) {
        ...
        try {
            ...
            // Solaris code must appear before the generic code
                ...
                if (osver.startsWith ("5.11")) {
                    ...
                    if (hostName != null) {
                        p = Runtime.getRuntime ().exec (new String[]{"/usr/sbin/arp", hostName},
                                                        null);
                    }
                }
            ...
            if (p != null) {
                ...
                while ((l = in.readLine ()) != null) {
                    ...
                    if (macA != null && HexUtils.parseShort (macA) != 0xff) {
                        break;
                    }
                }
            }
