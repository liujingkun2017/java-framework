 ...
 * <p/>
 * 本工具类提供添加系统钩子的方法,并且会在容器关闭时(我们都用到了日志,可以在com.cqfae.pmo.base.utils.logger.
...
public class ShutdownHooks {
     ...
     * <p/>
     * 避免容器关闭后,classloader关闭,容器加载类失败. https://issues.apache.org/bugzilla/show_bug.cgi?id=56387
     */
