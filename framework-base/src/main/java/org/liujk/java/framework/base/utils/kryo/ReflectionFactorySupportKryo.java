package org.liujk.java.framework.base.utils.kryo;
...
public class ReflectionFactorySupportKryo extends Kryo {
    private static final ReflectionFactory REFLECTION_FACTORY = ReflectionFactory
    ...
    private static <T> Constructor<?> newConstructorForSerialization (final Class<T> type) {
        try {
            final Constructor<?> constructor = REFLECTION_FACTORY.newConstructorForSerialization (
